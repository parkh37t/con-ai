 ...
 *
 * 경로: `#/`, `#/references`, `#/screens/:id/generate`, `#/screens/:id/review`, `#/screens/:id/approve`.
...
/** 홈·포트폴리오 링크. */
export function hrefTo(name: 'home' | 'references', query?: Query): string {
  return name === 'home' ? `#/${encodeQuery(query)}` : `#/references${encodeQuery(query)}`
}
