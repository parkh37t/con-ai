...
- **Express export 전 매번** `html_export_readiness_skill`로 자기완결 보장. **출력 직전, 미인라인된 외부 CDN(Mermaid 등)을 사전 렌더 SVG로 인라인**(작성 시 인라인은 wiley-diagram 책임, 출력 직전 보강이 render 책임).
